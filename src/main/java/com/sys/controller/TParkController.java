...
public class TParkController {
    ...
    public PageResult getParks_yd(PageTableRequest request,TPark tPark) {
        ...
        request.countOffset();
        return tParkService.getAllParksByPage_yd(request.getPage()-1,request.getRows(),tParkExample);
    }
    ...
    public PageResult getParks(PageTableRequest request,TPark tPark) {
        ...
        request.countOffset();
        return tParkService.getAllParksByPage(request.getPage()-1,request.getRows(),tParkExample);
    }
    ...
    public PageResult getParksDo(PageTableRequest request) {
        request.countOffset();
        return tParkService.getParksDo(request.getPage()-1,request.getRows());
    }
